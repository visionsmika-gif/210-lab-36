...
private:
   ...
   struct TreeNode {
      string value;      // The value in the node           // The value has been changed from a string to an int.
   ...
   void deleteNode(const string&, TreeNode *&);     // This function now takes a string instead of an int.
...
public:
   ...
   void insertNode(const string&);      // These functions now take a string as their parameter rather than an int.
...
void IntBinaryTree::insertNode(const string& val) {
...
bool IntBinaryTree::searchNode(const string& val) {
...
void IntBinaryTree::remove(const string& val) {
   deleteNode(val, root);
}

// deleteNode deletes the node whose value 
// member is the same as val.              
void IntBinaryTree::deleteNode(const string& val, TreeNode *&nodePtr) {
